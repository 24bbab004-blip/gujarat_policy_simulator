...
.stApp{background:linear-gradient(140deg,#f5f9ff 0%,#f8fbf8 54%,#f6f4ff 100%);font-family:'DM Sans',sans-serif;color:#172b4d}
...
with st.sidebar:
    ...
    page=st.radio("Navigation",list(PAGES),index=list(PAGES).index(st.session_state.get('page','Dashboard'))); st.session_state['page']=page
